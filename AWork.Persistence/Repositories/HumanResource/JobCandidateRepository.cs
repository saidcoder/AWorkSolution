...
{
    public class JobCandidateRepository : RepositoryBase<JobCandidate>, IJobCandidate
    {
        ...
        public async Task<JobCandidate> GetCategoryById(int jobCandidateId, bool trackChanges)
        {
