...
namespace AWork.Web.Controllers.Production
{
    public class LocationsServiceController : Controller
    {
        ...
        public LocationsServiceController(AdventureWorks2019Context context, IProductionServiceManager productionServiceManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("LocationId,Name,CostRate,Availability,ModifiedDate")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("LocationId,Name,CostRate,Availability,ModifiedDate")] Location location)
        {
