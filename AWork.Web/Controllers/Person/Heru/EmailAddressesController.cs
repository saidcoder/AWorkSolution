...
namespace AWork.Web.Controllers.Person.Heru
{
    public class EmailAddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BusinessEntityId,EmailAddressId,EmailAddress1,Rowguid,ModifiedDate")] EmailAddress emailAddress)
        {
            ...
            ViewData["BusinessEntityId"] = new SelectList(_context.People, "BusinessEntityId", "FirstName", emailAddress.BusinessEntityId);
            return View(emailAddress);
        }
        ...
        {
            return _context.EmailAddresses.Any(e => e.BusinessEntityId == id);
        }
    }
}
